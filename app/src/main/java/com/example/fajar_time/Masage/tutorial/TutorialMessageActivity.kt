package com.example.fajar_time.Masage.tutorial
...
import com.example.fajar_time.databinding.ActivityTutorialMessageBinding
...
class TutorialMessageActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adapter = TutorialFragmentAdapter(
            this,
            fragmentsList
        )
